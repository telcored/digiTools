...
<body>
    ...
    <?php echo '<div style=" border:solid 2px; height: 400px; width:500px; border-radius:10px;padding:30px;">'; ?>
        ...
        <form method="post" action="https://telcored.com/index.php/calculos-electricos/#referencia2">
            <label for="potencia12">Ingrese un valor en Amperes:</label>
            <input type="number" id="potencia12" name="potencia12" style="border-radius: 10px;width:100px;" required>
        ...
        </br></br> <h3 style="display:inline;">Resultado:   </h3><h3 id="resultado12p"  style="display:inline;"> </h3></br>
        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (is_numeric($numero)) {
                    ...
                    echo "</br>";
                    echo 'Formula:';
                    echo '<p style="margin:0; padding:0; ">  </br>Potencia[W] = Corriente[A] * 12 [V]</p>';
                    ...
                    function actualizarContenido($contenido) {
                        ...
                        echo 'document.getElementById("resultado12p").innerText = contenido;';
                        echo '</script>';
                    }
