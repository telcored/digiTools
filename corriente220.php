...
<body>
    ...
    <?php echo '<div style=" border:solid 2px; height: 400px; width:500px; border-radius:10px;padding:30px;">'; ?>
        ...
        <form method="post" action="https://telcored.com/index.php/calculos-electricos/#referencia8">
        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (is_numeric($numero)) {
                    ...
                    echo "</br>";
                    echo 'Formula:';
                    echo '<p style="margin:0; padding:0; ">  </br>Corriente[A] = Potencia[Watts] / (Voltaje * CosFi) </p>';
