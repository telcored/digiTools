...
<body>
    ...
    <?php echo '<div style=" border:solid 2px; height: 400px; width:500px; border-radius:10px;padding:30px;">'; ?>
        ...
        <h3>Cálculo corriente | 380[V] </h3>

        <!-- Formulario HTML para solicitar la potencia -->
        <form method="post" action="https://telcored.com/index.php/calculos-electricos/#referencia7">
            <label for="corriente380">Ingrese un valor en Watts:</label>
            <input type="number" id="corriente380" name="corriente380" style="border-radius: 10px;width:100px;" required>
        ...
        </br></br> <h3 style="display:inline;">Resultado:   </h3><h3 id="resultado380"  style="display:inline;"> </h3></br>
        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (is_numeric($numero)) {
                    ...
                    echo "</br>";
                    echo 'Formula:';
                    echo '<p style="margin:0; padding:0; ">  </br>Corriente[A] = Potencia[Watts] / (Voltaje * CosFi * raiz(3)) </p>';
                // echo "<p> $formateado [A] </p>";
                    ...
                    function actualizarContenido($contenido) {
                        ...
                        echo 'document.getElementById("resultado380").innerText = contenido;';
                        echo '</script>';
                    }
